...
const HeroLeft = ({ compact }) => {
  ...
  return (
    ...
    >
      ...
      {/* ── 6. Social links (GitHub + LinkedIn) ── */}
      <motion.div variants={SLIDE} style={{ display: "flex", gap: 10, alignItems: "center" }}>
        <a
          href={DATA.github}
          target="_blank"
        ...
        <span style={{ width: 1, height: 14, background: "var(--border-hover)", flexShrink: 0 }} />
        <a
